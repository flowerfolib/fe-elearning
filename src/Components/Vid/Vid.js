  ...
  return (
    <div className={styles.main}>
      <div className={styles.wrap}>
        ...
        <iframe ref={vidRef} width="1268" height="713" className={styles.vid} src="https://www.youtube.com/embed/3V0jdXteJdQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
    </div>
  )
}
